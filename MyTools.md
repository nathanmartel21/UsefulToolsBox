...
joomscan : Scan vulnérabilités Joomla

drupwn : Pentest Drupal

burpsuite : Proxy web pour CMS

wpsploit : Exploitation WordPress

joomlaXploit : Exploitation Joomla

cmsmap : Scan CMS

wputils : Outils WordPress

shellnoob : Détection backdoors WordPress

cavemanager : Gestion des CVE CMS

findsploit : Recherche exploits CMS

admin-finder : Trouver admin CMS

wpcanary : Détection changement WordPress

dirb : Fuzzing répertoires CMS

dirbuster : Fuzzing répertoires

gobuster : Scan répertoires CMS

joomla-enum : Enumération utilisateurs Joomla

burp-cms-scanner : Scan CMS Burp

joomla-version-checker : Vérification version Joomla

wp-scan : Scan plugins WordPress

wpcmscan : Scan sécurité WordPress

theme-check : Vérification thèmes WordPress

wpspy : Surveillance WordPress

wpcli : Commandes WordPress

joomla-bruteforce : Brute force Joomla

wpfast : Test rapide WordPress

drupalscan : Scan Drupal

joomla-scan : Scan Joomla

joomla-pentest-tools : Pentest Joomla

cms-fuzzer : Fuzzing CMS

wpsploit : Exploitation vulnérabilités WP

wpvulndb : Base vulnérabilités WP

joomla-vuln-db : Base vulnérabilités Joomla

exploit-db : Exploits CMS

WPScanDB : Base vulnérabilités WordPress

recon-ng : Recon CMS

sniffing-cms : Analyse CMS réseau

cms-exploit-framework : Framework exploit CMS

wpaudit : Audit sécurité WordPress

joomla-payloads : Payloads Joomla

phpmyadmin : Gestion bases de données CMS

wordpress-enum : Enumération utilisateurs WP

cms-cybersecurity : Sécurité CMS

wp-backdoor : Détection backdoors WP

wp-iot : Exploitation IoT WP

joomla-backdoor : Détection backdoors Joomla

webshells : Détection webshells

sucuri-scanner : Scan sécurité WP

droopescan : Scan vulnérabilités Drupal
